...
class BulletinNationalController extends GetxController {
  //TODO: Implement BulletinNationalController
  ...
  Future getBulletinList() async {
    var url = "${ApiURL.bulltin_list}?category=1&location=0&type=Current";
    var response = await http.get(Uri.parse(url));
    dynamic decode = jsonDecode(response.body);
    bulletinListCurrent.value = decode['result'];

    var url2 = "${ApiURL.bulltin_list}?category=1&location=0&type=Archive";
